...
- [Quarantining Untrusted AI Output](case-studies/model-output-quarantine.md) — a promotion gate that separates scanning, classification, byte identity, and provenance, including five independently reproduced bypasses fixed before release.
...
- [Model Output Promotion Rubric](frameworks/model-output-promotion-rubric.md) — a trust-boundary checklist for deciding whether exact AI-generated bytes may enter a tracked, published, or executable system.
